...
请从原始文本中提取每一行数据，输出为JSON数组。每一行包含以下10个字段（缺失则填"/"）：

1. 商品代码: 5-6位数字编号
2. 商品名称: 商品名称
3. 售卖单位: 如"瓶"、"盒"、"公斤"、"袋"、"包"等
4. 原售价: 原销售价格，纯数字
5. 现售价: 当前销售价格，纯数字
6. 原会员价: 原会员价格，纯数字
7. 现会员价: 当前会员价格，纯数字
...
只返回JSON数组，格式如下：
[{{"商品代码":"123456","商品名称":"示例商品","售卖单位":"瓶","原售价":"5.9","现售价":"5.5","原会员价":"5.5","现会员价":"5.0","生效日期":"6月25日","门店区域":"浙江","备注":"/"}}]"""
